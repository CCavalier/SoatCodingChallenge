(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('soatCodingChallengeApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-soatCodingChallengeApp-error');
                var entityKey = httpResponse.headers('X-soatCodingChallengeApp-params');
                if (errorHeader) {
